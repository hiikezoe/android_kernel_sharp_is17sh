...
#ifdef	CONFIG_SHLCDC_BOARD
int	mdp4_util_csc_convert_setup_exec=0;
#endif
...
#ifdef	CONFIG_SHLCDC_BOARD
	pipe = mdp4_overlay_ndx2pipe_pipeonly(p->id);
#else
...
#ifdef CONFIG_SHLCDC_BOARD
		memcpy(mdp_csc_convert[1].csc_mv, p->csc_mv, sizeof(p->csc_mv));
		memcpy(mdp_csc_convert[1].csc_pre_bv, p->csc_pre_bv,
			sizeof(p->csc_pre_bv));
		memcpy(mdp_csc_convert[1].csc_post_bv, p->csc_post_bv,
			sizeof(p->csc_post_bv));
		memcpy(mdp_csc_convert[1].csc_pre_lv, p->csc_pre_lv,
			sizeof(p->csc_pre_lv));
		memcpy(mdp_csc_convert[1].csc_post_lv, p->csc_post_lv,
			sizeof(p->csc_post_lv));
#endif
#ifdef	CONFIG_SHLCDC_BOARD
		mdp4_util_csc_convert_setup_exec=1;
#else

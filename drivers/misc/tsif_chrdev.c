...
#if defined(CONFIG_DTV_TUNERDEV) || defined(CONFIG_DTV_TUNERDEV_AF33)
#include <mach/gpio.h>
#define GPIO_TSIF_DATA_PORTNO	36
#define GPIO_TSIF_EN_PORTNO		35
#define GPIO_TSIF_CLK_PORTNO	34

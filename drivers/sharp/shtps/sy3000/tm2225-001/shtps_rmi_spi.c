/* drivers/sharp/shtps/sy3000/tm2225-001/shtps_rmi_spi.c
 *
...
//#define SHTPS_FACTORY_MODE_ENABLE
	...
	//#define SHTPS_DEBUG_PERFORMANCE_TIME_LOG_ENABLE
...
//#define SHTPS_WAKELOCK_IN_TOUCH_ENABLE

/* -----------------------------------------------------------------------------------
 */
#if defined( SHTPS_FACTORY_MODE_ENABLE )
	#define SHTPS_DEVICE_CHECK_ENABLE
	#define SHTPS_GESTURE_FLAG_ENABLE
#else
	#define SHTPS_BOOT_FWUPDATE_ENABLE
	//#define SHTPS_BOOT_FWUPDATE_FORCE_UPDATE
#endif /* defined( SHTPS_FACTORY_MODE_ENABLE ) */
...
#endif /* #if defined( CONFIG_SHTPS_SY3000_TM1980_001 ) */

#if defined( CONFIG_SHTPS_SY3000_TM2179_001 )
	#define SHTPS_SY_REGMAP_BASE3
	#define SHTPS_SMEM_BASELINE_ENABLE
	#define SHTPS_LEGACYPANEL_SUPPORT
	#define SHTPS_HOST_POS_FILTER_ENABLE
#endif /* #if defined( CONFIG_SHTPS_SY3000_TM2179_001 ) */

#if defined( CONFIG_SHTPS_SY3000_TM2225_001 )
	#define SHTPS_SY_REGMAP_BASE3
	#define SHTPS_SMEM_BASELINE_ENABLE
	//#define SHTPS_HOST_POS_FILTER_ENABLE
	#define SHTPS_DISABLE_ABS_POSFILTER
 ...
 */
	...
	#define	SHTPS_SY3X00_SPI_CLOCK_READ_WAIT	63
...
#define	SHTPS_SY3X00_SPI_CLOCK_FW_WRITE_WAIT	63
...
#define	SHTPS_SY3X00_SPIBLOCK_FWWRITE_BUFSIZE	18

/* -----------------------------------------------------------------------------------
 */
#if defined( CONFIG_SHTPS_SY3000_TM1737_001 )
	#include "shtps_fw_tm1737-001.h"
#elif defined( CONFIG_SHTPS_SY3000_TM1737_003 )
	#include "shtps_fw_tm1737-003.h"
#elif defined( CONFIG_SHTPS_SY3000_TM1836_001 )
	...
	#include "shtps_fw_tm2179-001.h"
#elif defined( CONFIG_SHTPS_SY3000_TM2225_001 )
	#include "shtps_fw_tm2225-001.h"
#else
 ...
 */
	...
	static int SHTPS_DRAG_THRESH_VAL_X_1ST = 		8;
	...
	static int SHTPS_DRAG_THRESH_VAL_Y_1ST = 		8;
	...
	#if defined( SHTPS_HOST_POS_FILTER_ENABLE )
	static int SHTPS_POS_FILTER_BUFSIZE = 				(14+1);
	static int SHTPS_POS_FILTER_WIDTH_FINGER_THRESH = 	7;
	static int SHTPS_POS_FILTER_WIDTH_FINGER_THRESH2 = 	5;
	
	static int SHTPS_POS_FILTER_THRESH_1ST = 			100;
	static int SHTPS_POS_FILTER_THRESH_2ND = 			40;
	static int SHTPS_POS_FILTER_FACTOR_1ST = 			200;
	static int SHTPS_POS_FILTER_FACTOR_2ND = 			500;
	static int SHTPS_POS_FILTER_SAMPLES = 				4;
	static int SHTPS_POS_FILTER_SAMPLE_USE = 			2;
	
	static int SHTPS_POS_FILTER_WIDTH_THRESH_1ST = 		200;
	static int SHTPS_POS_FILTER_WIDTH_THRESH_2ND = 		100;
	static int SHTPS_POS_FILTER_WIDTH_FACTOR_1ST = 		200;
	static int SHTPS_POS_FILTER_WIDTH_FACTOR_2ND = 		500;
	static int SHTPS_POS_FILTER_WIDTH_SAMPLES = 		8;
	static int SHTPS_POS_FILTER_WIDTH_SAMPLE_USE = 		2;

	static int SHTPS_POS_FILTER_DIF_SAMPLES = 			6;
	static int SHTPS_POS_FILTER_DIF_FACTOR = 			3;
	static int SHTPS_POS_FILTER_DIF_THRESH = 			15;
	
	static int SHTPS_POS_FILTER_VERTICAL_ENABLE =		0;
	#endif /* #if defined( SHTPS_HOST_POS_FILTER_ENABLE ) */
	
#else /* #if defined( SHTPS_DEBUG_VARIABLE_DEFINES ) */
	#define SHTPS_DRAG_THRESH_VAL_X_1ST 			8
	...
	#define SHTPS_DRAG_THRESH_VAL_Y_1ST 			8
	...
	#if defined( SHTPS_HOST_POS_FILTER_ENABLE )
	#define SHTPS_POS_FILTER_BUFSIZE				(14+1)
	#define SHTPS_POS_FILTER_WIDTH_FINGER_THRESH	7
	#define SHTPS_POS_FILTER_WIDTH_FINGER_THRESH2	5
	
	#define SHTPS_POS_FILTER_THRESH_1ST				100
	#define SHTPS_POS_FILTER_THRESH_2ND				40
	#define SHTPS_POS_FILTER_FACTOR_1ST				200
	#define SHTPS_POS_FILTER_FACTOR_2ND				500
	#define SHTPS_POS_FILTER_SAMPLES				4
	#define SHTPS_POS_FILTER_SAMPLE_USE				2
	
	#define SHTPS_POS_FILTER_WIDTH_THRESH_1ST		200
	#define SHTPS_POS_FILTER_WIDTH_THRESH_2ND		100
	#define SHTPS_POS_FILTER_WIDTH_FACTOR_1ST		200
	#define SHTPS_POS_FILTER_WIDTH_FACTOR_2ND		500
	#define SHTPS_POS_FILTER_WIDTH_SAMPLES			8
	#define SHTPS_POS_FILTER_WIDTH_SAMPLE_USE		2

	#define SHTPS_POS_FILTER_DIF_SAMPLES			6
	#define SHTPS_POS_FILTER_DIF_FACTOR				3
	#define SHTPS_POS_FILTER_DIF_THRESH				15
	
	#define SHTPS_POS_FILTER_VERTICAL_ENABLE		0
	#endif /* #if defined( SHTPS_HOST_POS_FILTER_ENABLE ) */
...
#define SHTPS_LOADERCMD_WAIT_US					750
 ...
 */
#if defined( CONFIG_SHTPS_SY3000_TM2153_001 )
	#define SHTPS_NUM_OF_2D_RX_ELECTRODES	0x11
	#define SHTPS_NUM_OF_2D_TX_ELECTRODES	0x0A
#elif defined( CONFIG_SHTPS_SY3000_TM2225_001 )
	#define SHTPS_NUM_OF_2D_RX_ELECTRODES	0x13
	#define SHTPS_NUM_OF_2D_TX_ELECTRODES	0x0B
#else
	#define SHTPS_NUM_OF_2D_RX_ELECTRODES	0x13
	#define SHTPS_NUM_OF_2D_TX_ELECTRODES	0x0B
#endif
 ...
 */
#if defined( SHTPS_HOST_POS_FILTER_ENABLE )
#define SHTPS_FSLUR_HISTORY_SIZE	2
#define SHTPS_FSLUR_POS_X			0
#define SHTPS_FSLUR_POS_Y			1
//#define SHTPS_FSLUR_THRESHOLD		7
static int SHTPS_FSLUR_THRESHOLD = 	10;

struct posfilter_info{
	int count;
	int top;
	int tail;
	int history[20];
...
struct fingerslur_info{
	int	cnt;
	int history[SHTPS_FSLUR_HISTORY_SIZE];
};
#endif /* #if defined( SHTPS_HOST_POS_FILTER_ENABLE ) */
...
#if defined( SHTPS_LEGACYPANEL_SUPPORT )
	u8							legacy_panel;
#endif /* #if defined( SHTPS_LEGACYPANEL_SUPPORT ) */
...
#if defined( SHTPS_HOST_POS_FILTER_ENABLE )
	struct fingerslur_info		fslurinfo[2];
	struct posfilter_info		poshist[SHTPS_FINGER_MAX][2];
#endif /* #if defined( SHTPS_HOST_POS_FILTER_ENABLE ) */

#if defined( SHTPS_WAKELOCK_IN_TOUCH_ENABLE )
	u8							wake_lock_state;
	struct wake_lock			wake_lock_idle;
	struct wake_lock			wake_lock_suspend;
#endif /* #if defined( SHTPS_WAKELOCK_IN_TOUCH_ENABLE ) */
...
struct shtps_state_func {
...
#if defined( SHTPS_VKEY_INVALID_AREA_ENABLE )
	//#define SHTPS_VKEY_INVALID_AREA_DEBUG_ENABLE
	#if defined( SHTPS_VKEY_INVALID_AREA_DEBUG_ENABLE )
		static int shtps_invarea_debug_bottom = 46;
		static int shtps_invarea_debug_left   = 25;
		static int shtps_invarea_debug_right  = 25;
	...
	#endif /* #if defined( SHTPS_VKEY_INVALID_AREA_DEBUG_ENABLE ) */
#endif /* #if defined( SHTPS_VKEY_INVALID_AREA_ENABLE ) */
...
/* -----------------------------------------------------------------------------------
 */
static ssize_t show_invarea(struct device *dev, struct device_attribute *attr,
              char *buf)
{
    return snprintf(buf, PAGE_SIZE,
            "touch key invalid area :\n"
            "  top  = %d dot\n"
            "  left = %d dot\n"
            "  right= %d dot\n",
            shtps_invarea_debug_bottom,
            shtps_invarea_debug_left,
            shtps_invarea_debug_right
            );
}

static ssize_t set_invarea(struct device *dev, struct device_attribute *attr,
             const char *buf, size_t count)
{
	...
	shtps_invalid_area[0].ey = CONFIG_SHTPS_SY3000_LCD_SIZE_Y + (shtps_invarea_debug_bottom - 1);
	shtps_invalid_area[1].ex = shtps_invarea_debug_left - 1;
	shtps_invalid_area[2].sx = CONFIG_SHTPS_SY3000_PANEL_SIZE_X - (shtps_invarea_debug_right - 1);

   return count;
}

static DEVICE_ATTR(invarea, S_IRUGO | S_IWUSR, show_invarea, set_invarea);
#endif /* #if defined( SHTPS_VKEY_INVALID_AREA_DEBUG_ENABLE ) */
...
#if defined( SHTPS_HOST_POS_FILTER_ENABLE )
#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
static ssize_t show_posret(struct device *dev, struct device_attribute *attr,
			  char *buf)
{
	return snprintf(buf, PAGE_SIZE,
			"pos retusn threshold : %ddot\n",
			SHTPS_FSLUR_THRESHOLD
			);
}

static ssize_t set_posret(struct device *dev, struct device_attribute *attr,
			 const char *buf, size_t count)
{
	int threshold;
	
	sscanf(buf,"%d", &threshold);
	SHTPS_FSLUR_THRESHOLD = threshold;
	return count;
}

static DEVICE_ATTR(posret, S_IRUGO | S_IWUSR, show_posret, set_posret);

static ssize_t show_posfilter(struct device *dev, struct device_attribute *attr,
			  char *buf)
{
	return snprintf(buf, PAGE_SIZE,
			"buffer size             : %d\n"
			"finger width threshold  : %d\n"
			"finger width threshold2 : %d\n"
			"---\n"
			"threshold(1)            : %d\n"
			"threshold(2)            : %d\n"
			"factor(1)               : 0.%03d\n"
			...
			"width threshold(1)      : %d\n"
			"width threshold(2)      : %d\n"
			"width factor(1)         : 0.%03d\n"
			"width factor(2)         : 0.%03d\n"
			"width avg sample num    : %d\n"
			"width avg use num       : %d\n"
			"---\n"
			"diff sample num         : %d\n"
			"diff factor             : %d\n"
			...
			SHTPS_POS_FILTER_BUFSIZE-1,
			SHTPS_POS_FILTER_WIDTH_FINGER_THRESH,
			SHTPS_POS_FILTER_WIDTH_FINGER_THRESH2,
			
			SHTPS_POS_FILTER_THRESH_1ST,
			SHTPS_POS_FILTER_THRESH_2ND,
			SHTPS_POS_FILTER_FACTOR_1ST,
			SHTPS_POS_FILTER_FACTOR_2ND,
			SHTPS_POS_FILTER_SAMPLES,
			SHTPS_POS_FILTER_SAMPLE_USE,
			
			SHTPS_POS_FILTER_WIDTH_THRESH_1ST,
			SHTPS_POS_FILTER_WIDTH_THRESH_2ND,
			SHTPS_POS_FILTER_WIDTH_FACTOR_1ST,
			SHTPS_POS_FILTER_WIDTH_FACTOR_2ND,
			SHTPS_POS_FILTER_WIDTH_SAMPLES,
			SHTPS_POS_FILTER_WIDTH_SAMPLE_USE,
			
			SHTPS_POS_FILTER_DIF_SAMPLES,
			SHTPS_POS_FILTER_DIF_FACTOR,
			SHTPS_POS_FILTER_DIF_THRESH
			);
}

static ssize_t set_posfilter(struct device *dev, struct device_attribute *attr,
			 const char *buf, size_t count)
{
	int bufsize, width, width2,
		th1, th2, fact1, fact2, samples, sampleuse,
		wth1,wth2,wfact1,wfact2,wsamples,wsampleuse,
		diffsamples, difffactor, diffth;

	sscanf(buf,"%d %d %d %d %d %d %d %d %d "
			   "%d %d %d %d %d %d "
			   "%d %d %d",
			   &bufsize, &width, &width2,
			   &th1, &th2, &fact1, &fact2, &samples, &sampleuse,
			   &wth1, &wth2, &wfact1, &wfact2, &wsamples, &wsampleuse,
			   &diffsamples, &difffactor, &diffth);

	SHTPS_POS_FILTER_BUFSIZE				= bufsize+1;
	SHTPS_POS_FILTER_WIDTH_FINGER_THRESH	= width;
	SHTPS_POS_FILTER_WIDTH_FINGER_THRESH2	= width2;
	
	SHTPS_POS_FILTER_THRESH_1ST				= th1;
	SHTPS_POS_FILTER_THRESH_2ND				= th2;
	SHTPS_POS_FILTER_FACTOR_1ST				= fact1;
	SHTPS_POS_FILTER_FACTOR_2ND				= fact2;
	SHTPS_POS_FILTER_SAMPLES 				= samples;
	SHTPS_POS_FILTER_SAMPLE_USE  	 		= sampleuse;

	SHTPS_POS_FILTER_WIDTH_THRESH_1ST		= wth1;
	SHTPS_POS_FILTER_WIDTH_THRESH_2ND		= wth2;
	SHTPS_POS_FILTER_WIDTH_FACTOR_1ST		= wfact1;
	SHTPS_POS_FILTER_WIDTH_FACTOR_2ND		= wfact2;
	SHTPS_POS_FILTER_WIDTH_SAMPLES 			= wsamples;
	SHTPS_POS_FILTER_WIDTH_SAMPLE_USE   	= wsampleuse;

	SHTPS_POS_FILTER_DIF_SAMPLES			= diffsamples;
	SHTPS_POS_FILTER_DIF_FACTOR				= difffactor;
	SHTPS_POS_FILTER_DIF_THRESH				= diffth;

	return count;
}

static DEVICE_ATTR(posfilter, S_IRUGO | S_IWUSR, show_posfilter, set_posfilter);

static ssize_t show_vposfilter(struct device *dev, struct device_attribute *attr,
			  char *buf)
{
	return snprintf(buf, PAGE_SIZE,
			"vertical pos filter : %s\n",
			(SHTPS_POS_FILTER_VERTICAL_ENABLE != 0)? "enable" : "disable"
			);
}

static ssize_t set_vposfilter(struct device *dev, struct device_attribute *attr,
			 const char *buf, size_t count)
{
	int enable;
	sscanf(buf,"%d", &enable);
	SHTPS_POS_FILTER_VERTICAL_ENABLE = enable;
	return count;
}

static DEVICE_ATTR(verticalposfilter, S_IRUGO | S_IWUSR, show_vposfilter, set_vposfilter);

#endif /* #if defined( SHTPS_DEBUG_VARIABLE_DEFINES ) */

static inline void shtps_posfilter_addbuf(struct posfilter_info *info, int bufsize, int data)
{
	if(info->count < bufsize){
		info->history[info->tail] = data;
		info->tail = (info->tail + 1) % bufsize;
		info->count++;
	}else{
		info->history[info->tail] = data;
		info->tail = (info->tail + 1) % bufsize;
		info->top  = (info->top  + 1) % bufsize;
	}
}

static inline int shtps_posfilter_getbufdata(struct posfilter_info *info, int bufsize, int index)
{
	index = (info->top + index) % bufsize;
	return info->history[index];
}

static inline void shtps_posfilter_addhistory(struct shtps_rmi_spi *ts, int finger, int xy, unsigned short pos)
{
	shtps_posfilter_addbuf(&ts->poshist[finger][xy], SHTPS_POS_FILTER_BUFSIZE, (int)pos);
}

static inline int shtps_posfilter_ishistoryfull(struct shtps_rmi_spi *ts, int finger, int xy)
{
	return (ts->poshist[finger][xy].count >= SHTPS_POS_FILTER_BUFSIZE);
}

static inline void shtps_posfilter_getminmax(struct shtps_rmi_spi *ts, int finger, int xy, int *min, int *max)
{
	int i;
	*min = 9999;
	*max = 0;
	for(i = 0;i < SHTPS_POS_FILTER_BUFSIZE;i++){
		if(*max < ts->poshist[finger][xy].history[i]){
			*max = ts->poshist[finger][xy].history[i];
		}
		if(*min >  ts->poshist[finger][xy].history[i]){
			*min = ts->poshist[finger][xy].history[i];
		}
	}
}

static inline int shtps_posfilter_getavg(struct shtps_rmi_spi *ts, int finger, int xy, int samples, int use)
{
	int num = (samples > ts->poshist[finger][xy].count)?
					ts->poshist[finger][xy].count : samples;
	int i, j;
	int buf[20];
	int avg = 0;
	int max_min_num = (num - use) / 2;
			
	for(i = 0;i < num;i++){
		buf[i] = shtps_posfilter_getbufdata(&ts->poshist[finger][xy], 
					SHTPS_POS_FILTER_BUFSIZE, ts->poshist[finger][xy].count - 1 - i);
		avg += buf[i];
	}
	...
	for(i = 0;i < max_min_num;i++){
		avg -= (buf[i] + buf[num - 1 - i]);
	}
	
	return (avg / use);
}

static inline void shtps_posfilter_hisdif(struct shtps_rmi_spi *ts, int finger, int xy, int *diffmax)
{
	int i;
	int diff;
	...
	*diffmax = 0;
	...
	for(i = 0;i < SHTPS_POS_FILTER_DIF_SAMPLES;i++){
		diff = abs(shtps_posfilter_getbufdata(&ts->poshist[finger][xy], 
						SHTPS_POS_FILTER_BUFSIZE, ts->poshist[finger][xy].count - 2 - i) - 
				   shtps_posfilter_getbufdata(&ts->poshist[finger][xy], 
						SHTPS_POS_FILTER_BUFSIZE, ts->poshist[finger][xy].count - 3 - i));
...
static inline void shtps_posfilter_curdif(struct shtps_rmi_spi *ts, int finger, int xy, int *diff1, int *diff2)
{
	*diff1 = abs(shtps_posfilter_getbufdata(&ts->poshist[finger][xy],
					SHTPS_POS_FILTER_BUFSIZE, ts->poshist[finger][xy].count - 1) - 
				 shtps_posfilter_getbufdata(&ts->poshist[finger][xy], 
					SHTPS_POS_FILTER_BUFSIZE, ts->poshist[finger][xy].count - 2));

	*diff2 = abs(shtps_posfilter_getbufdata(&ts->poshist[finger][xy],
					SHTPS_POS_FILTER_BUFSIZE, ts->poshist[finger][xy].count - 1) - 
				 shtps_posfilter_getbufdata(&ts->poshist[finger][xy], 
					SHTPS_POS_FILTER_BUFSIZE, ts->poshist[finger][xy].count - 3));
}

static inline void shtps_posfilter_main(struct shtps_rmi_spi *ts, int finger, int xy, unsigned short *pos_p, int width)
{
	shtps_posfilter_addhistory(ts, finger, xy, *pos_p);
	
	if(shtps_posfilter_ishistoryfull(ts, finger, xy)){
		int avg;
		int min;
		int max;
		int hisdif;
		...
		shtps_posfilter_getminmax(ts, finger, xy, &min, &max);
		
		if(width >= SHTPS_POS_FILTER_WIDTH_FINGER_THRESH){
			avg = shtps_posfilter_getavg(ts, finger, xy,
						SHTPS_POS_FILTER_WIDTH_SAMPLES, SHTPS_POS_FILTER_WIDTH_SAMPLE_USE);
			
			if((max - min) >= SHTPS_POS_FILTER_WIDTH_THRESH_1ST){
				*pos_p = *pos_p - (((*pos_p - avg) * SHTPS_POS_FILTER_WIDTH_FACTOR_1ST) / 1000);
			}else if((max - min) >= SHTPS_POS_FILTER_WIDTH_THRESH_2ND){
				*pos_p = *pos_p - (((*pos_p - avg) * SHTPS_POS_FILTER_WIDTH_FACTOR_2ND) / 1000);
			}else{
				*pos_p = avg;
			}
		}else if(width > SHTPS_POS_FILTER_WIDTH_FINGER_THRESH2){
			avg = shtps_posfilter_getavg(ts, finger, xy,
						SHTPS_POS_FILTER_SAMPLES, SHTPS_POS_FILTER_SAMPLE_USE);
			
			if((max - min) >= SHTPS_POS_FILTER_THRESH_1ST){
				*pos_p = *pos_p - (((*pos_p - avg) * SHTPS_POS_FILTER_FACTOR_1ST) / 1000);
			}else if((max - min) >= SHTPS_POS_FILTER_THRESH_2ND){
				*pos_p = *pos_p - (((*pos_p - avg) * SHTPS_POS_FILTER_FACTOR_2ND) / 1000);
			}else{
				*pos_p = avg;
			}
		}else{
			shtps_posfilter_hisdif(ts, finger, xy, &hisdif);
			shtps_posfilter_curdif(ts, finger, xy, &curdif, &curdif2);
			hisdif *= SHTPS_POS_FILTER_DIF_FACTOR;
			...
			if((max - min) >= SHTPS_POS_FILTER_THRESH_1ST){
				*pos_p = *pos_p - (((*pos_p - avg) * SHTPS_POS_FILTER_FACTOR_1ST) / 1000);
				...
				if(((curdif >= hisdif) || (curdif2 >= hisdif)) && 
					((curdif >= SHTPS_POS_FILTER_DIF_THRESH) || (curdif2 >= SHTPS_POS_FILTER_DIF_THRESH)))
				{
					*pos_p = *pos_p - (((*pos_p - avg) * SHTPS_POS_FILTER_FACTOR_1ST) / 1000);
				}else{
					*pos_p = *pos_p - (((*pos_p - avg) * SHTPS_POS_FILTER_FACTOR_2ND) / 1000);
...
static void shtps_posfilter_init(struct shtps_rmi_spi *ts)
{
	memset(ts->poshist, 0, sizeof(ts->poshist));
}

static void shtps_posfilter(struct shtps_rmi_spi *ts, int finger, int xy, unsigned short *pos, int w)
{
	shtps_posfilter_main(ts, finger, xy, pos, w);
}

static inline void shtps_fingerslur_init(struct shtps_rmi_spi *ts, int xy)
{
	ts->fslurinfo[xy].cnt = 0;
	memset(ts->fslurinfo[xy].history, 0, sizeof(ts->fslurinfo[xy].history));
}

static inline void shtps_fingerslur_addhistory(struct shtps_rmi_spi *ts, int xy, unsigned short pos)
{
	ts->fslurinfo[xy].history[ts->fslurinfo[xy].cnt] = pos;
	ts->fslurinfo[xy].cnt++;
}

static inline void shtps_fingerslur_updatehistory(struct shtps_rmi_spi *ts, int xy, unsigned short pos)
{
	if(ts->fslurinfo[xy].cnt > 0){
		ts->fslurinfo[xy].history[ts->fslurinfo[xy].cnt-1] = pos;
	}
}

static inline unsigned short shtps_fingerslur_gethistory(struct shtps_rmi_spi *ts, int xy)
{
	unsigned short ret = 0;

	if(ts->fslurinfo[xy].cnt > 0){
		ret = ts->fslurinfo[xy].history[ts->fslurinfo[xy].cnt-1];
	}
	return ret;
}

static inline int shtps_fingerslur_gethistorydir(struct shtps_rmi_spi *ts, int xy)
{
	int ret = 0;
	if(ts->fslurinfo[xy].cnt > 1){
		ret = (ts->fslurinfo[xy].history[ts->fslurinfo[xy].cnt-1] >= 
					ts->fslurinfo[xy].history[ts->fslurinfo[xy].cnt-2])? 1 : -1;
	}
	return ret;
}

static inline int shtps_fingerslur_ishistoryfull(struct shtps_rmi_spi *ts, int xy)
{
	return (ts->fslurinfo[xy].cnt >= SHTPS_FSLUR_HISTORY_SIZE);
}

static void shtps_check_fingerslur_main(struct shtps_rmi_spi *ts, int xy, unsigned short *pos_p)
{
	int posdir;
	int posval = *pos_p;

	if(shtps_fingerslur_ishistoryfull(ts, xy)){
		posdir  = (posval >= shtps_fingerslur_gethistory(ts, xy))? 1 : -1;

		if(shtps_fingerslur_gethistorydir(ts, xy) != posdir){
			int diff = shtps_get_diff(posval, shtps_fingerslur_gethistory(ts, xy), 
							(xy == SHTPS_FSLUR_POS_X)? SHTPS_POS_SCALE_X(ts) : SHTPS_POS_SCALE_Y(ts));
			if(diff > SHTPS_FSLUR_THRESHOLD){
				shtps_fingerslur_init(ts, xy);
				return;
			}else{
				*pos_p = shtps_fingerslur_gethistory(ts, xy);
				return;
			}
		}else{
			shtps_fingerslur_updatehistory(ts, xy, posval);
		}
	}else{
		shtps_fingerslur_addhistory(ts, xy, posval);
	}
}

static void shtps_fingerslur_check(struct shtps_rmi_spi *ts, unsigned short *x_p, unsigned short *y_p)
{
	shtps_check_fingerslur_main(ts, SHTPS_FSLUR_POS_X, x_p);
	shtps_check_fingerslur_main(ts, SHTPS_FSLUR_POS_Y, y_p);
}
#endif /* #if defined( SHTPS_HOST_POS_FILTER_ENABLE ) */
...
static int shtps_device_access_setup(struct shtps_rmi_spi *ts)
{
	...
	#if defined( SHTPS_WAKELOCK_IN_TOUCH_ENABLE )
		if(!ts->wake_lock_state){
			ts->wake_lock_state = 1;
			wake_lock(&ts->wake_lock_idle);
		}
	#endif /* #if defined( SHTPS_WAKELOCK_IN_TOUCH_ENABLE ) */
...
static int shtps_device_access_teardown(struct shtps_rmi_spi *ts)
{
	...
	#if defined( SHTPS_WAKELOCK_IN_TOUCH_ENABLE )
		if(ts->wake_lock_state){
			ts->wake_lock_state = 0;
			wake_unlock(&ts->wake_lock_idle);
		}
	#endif /* #if defined( SHTPS_WAKELOCK_IN_TOUCH_ENABLE ) */
...
static int shtps_rmi_write_fw_data(struct shtps_rmi_spi *ts, u16 addr, u8 *buf)
{
	...
	u8					tx_buf[SHTPS_SY3X00_SPIBLOCK_FWWRITE_BUFSIZE+2];
	u16					size;
	u32					s;
	int					status;
	int					retry;
	...
	size = F34_QUERY_BLOCKSIZE(ts->map.fn34.query.data);
	s	 = size;
	for(i=0;i<size;i+=SHTPS_SY3X00_SPIBLOCK_FWWRITE_BUFSIZE){
		retry = 3;
		do{
			memset(&t, 0, sizeof(t));
			...
			t.len			= 2 + (s > SHTPS_SY3X00_SPIBLOCK_FWWRITE_BUFSIZE)?
								(SHTPS_SY3X00_SPIBLOCK_FWWRITE_BUFSIZE) : (s);
			tx_buf[0] 		= (((addr+i) >> 8) & 0xff);
			tx_buf[1] 		= (addr+i) & 0xff;

			memcpy(&tx_buf[2], buf, t.len-2);
		...
		s -= SHTPS_SY3X00_SPIBLOCK_FWWRITE_BUFSIZE;
	...
	for(page = 0;page < 2;page++){
		...
		for(i = 0xE9;i > 0x0a;i-=sizeof(pdt)){
			...
			case 0x01:
				...
				#if defined( SHTPS_LEGACYPANEL_SUPPORT )
				if(strcmp(productID, "TM1918-001") == 0 || strcmp(productID, "TM1963-001") == 0){
					ts->legacy_panel = 1;
				}else{
					ts->legacy_panel = 0;
				}
...
static u16 shtps_data_atoi(u8* ver, u16 len)
{
	...
	for(count = 0;count < len;count++){
		if('0' <= ver[count] && ver[count] <= '9'){
			result |= (ver[count] - '0') << ((len - 1 - count) * len);
		}else if('A' <= ver[count] && ver[count] <= 'F'){
			result |= (ver[count] - 'A') << ((len - 1 - count) * len);
		}else if('a' <= ver[count] && ver[count] <= 'f'){
			result |= (ver[count] - 'a') << ((len - 1 - count) * len);
		}else{
			SHTPS_LOG_ERR_PRINT("%s ERROR(%c)\n", __func__, ver[count]);
			return 0;
		}
	}
	return result;
...
static int shtps_set_charger_armor(struct shtps_rmi_spi *ts, int on)
{
	...
	if(on != 0){
		if(ts->charger_armor_state == 0){
			...
			rc = shtps_rmi_write(ts, ts->map.fn11.ctrlBase, data | 0x08);
			SPI_ERR_CHECK(rc, err_exit);
			
			rc = shtps_rmi_write(ts, ts->map.fn11.ctrlBase + 0x39, SHTPS_CHARGER_ARMOR_STRENGTH);
			SPI_ERR_CHECK(rc, err_exit);
		...
		if(ts->charger_armor_state != 0){
			rc = shtps_rmi_read(ts, ts->map.fn11.ctrlBase, &data, 1);
			SPI_ERR_CHECK(rc, err_exit);
			rc = shtps_rmi_write(ts, ts->map.fn11.ctrlBase, data & 0xF7);
			SPI_ERR_CHECK(rc, err_exit);
...
static u16 shtps_fwver(struct shtps_rmi_spi *ts)
{
	...
	do{
		shtps_rmi_read(ts, ts->map.fn34.ctrlBase, ver, 4);
...
#if defined( SHTPS_HOST_POS_FILTER_ENABLE ) || defined( SHTPS_DISABLE_ABS_POSFILTER )
		rc = shtps_rmi_write(ts, ts->map.fn11.ctrlBase, (data & 0xF0) | 0x00);
#else
		rc = shtps_rmi_write(ts, ts->map.fn11.ctrlBase, (data & 0xF8) | 0x00);
#endif /* #if defined( SHTPS_HOST_POS_FILTER_ENABLE ) || defined( SHTPS_DISABLE_ABS_POSFILTER ) */
		SPI_ERR_CHECK(rc, err_exit);
...
static void shtps_calc_notify(struct shtps_rmi_spi *ts, u8 *buf, struct shtps_touch_info *info, u8 *event)
{
	...
	for(i = 0;i < fingerMax;i++){
		...
		#if defined( SHTPS_HOST_POS_FILTER_ENABLE )
		if(info->fingers[i].state == 0x01){
			shtps_posfilter(ts, i, SHTPS_POSTYPE_X, &info->fingers[i].x, 
								(info->fingers[i].wx >= info->fingers[i].wy)? 
									info->fingers[i].wx : info->fingers[i].wy);

			if(SHTPS_POS_FILTER_VERTICAL_ENABLE){
				shtps_posfilter(ts, i, SHTPS_POSTYPE_Y, &info->fingers[i].y, 
									(info->fingers[i].wx >= info->fingers[i].wy)? 
										info->fingers[i].wx : info->fingers[i].wy);
			}
			
			if(i == 0 && numOfFingers == 1){
				shtps_fingerslur_check(ts, &info->fingers[i].x, &info->fingers[i].y);
			}
		}
		#endif /* #if defined( SHTPS_HOST_POS_FILTER_ENABLE ) */
	...
	if(ts->thinout_event_mode){
		if(*event == SHTPS_EVENT_DRAG){
			if(!ts->drop_event){
				SHTPS_LOG_DBG_PRINT("set drop_event flag\n");
				*event = 0xFF;
				ts->drop_event = 1;
				...
				SHTPS_LOG_DBG_PRINT("clear drop_event flag\n");
				ts->drop_event = 0;
			}
		}else if(*event == SHTPS_EVENT_TU){
			if(ts->drop_event){
				SHTPS_LOG_DBG_PRINT("notify last drop event !!\n");
...
inline static void shtps_report_touch_cancel(struct shtps_rmi_spi *ts, int finger)
{
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 0, 0))
	input_mt_slot(ts->input, finger);
	input_mt_report_slot_state(ts->input, MT_TOOL_FINGER, true);
	...
	SHTPS_LOG_EVENT( printk(KERN_DEBUG "[shtps][touchcancel]Notify event[%d] touch=100(%d), x=%d, y=%d w=%d\n",
						finger, 1, 0, 9999, 1); );
}
...
{
	int receive_num = SHTPS_NUM_OF_2D_RX_ELECTRODES;
...
{
	int trans_num = SHTPS_NUM_OF_2D_TX_ELECTRODES;
...
static void shtps_read_touchevent(struct shtps_rmi_spi *ts, int state)
{
...
#if defined( SHTPS_SPI_BLOCKREAD_ENABLE )
	shtps_rmi_read(ts, ts->map.fn01.dataBase, buf, 2);
	shtps_rmi_read(ts, ts->map.fn11.dataBase, &buf[2], (readsize - 2) + 2 * 5);

	#ifdef	SHTPS_MAXFINGER_5_ENABLE
		if(fingerMax > 5){
			buf[3] &= 0x03;
			buf[4] = 0;
		}
	#endif /* SHTPS_MAXFINGER_5_ENABLE */
	...
	for(finger = 2;finger < fingerMax;finger++){
		...
		buf[4] = 0;
	#else
		shtps_rmi_read(ts, ts->map.fn01.dataBase, buf, readsize);
	#endif
...
#if defined( SHTPS_GESTURE_FLAG_ENABLE )
	#if defined( SHTPS_SY_REGMAP_BASE3 )
	...
	#endif /* #if defined( SHTPS_SY_REGMAP_BASE3 ) */
#endif /* #if defined( SHTPS_GESTURE_FLAG_ENABLE ) */
	...
	case SHTPS_STATE_SLEEP_FACETOUCH:
			...
			#if defined( SHTPS_HOST_POS_FILTER_ENABLE )
				if(ts->touch_state.numOfFingers == 0){
					shtps_posfilter_init(ts);
					shtps_fingerslur_init(ts, SHTPS_FSLUR_POS_X);
					shtps_fingerslur_init(ts, SHTPS_FSLUR_POS_Y);
				}
			#endif /* #if defined( SHTPS_HOST_POS_FILTER_ENABLE ) */
...
{
#if defined( SHTPS_DEVICE_CHECK_ENABLE )
	u8 buf;
	shtps_rmi_write(ts, 0xFF, 0x00);
...
#else
	return 1;
#endif /* #if defined( SHTPS_DEVICE_CHECK_ENABLE ) */
}
#endif /* #if defined( SHTPS_BOOT_FWUPDATE_ENABLE ) */
...
static int shtps_flash_writeConfig(struct shtps_rmi_spi *ts, u8 *fwdata)
{
	...
	for(block = 0;block < blockNum;block++){
		#if defined( SHTPS_SPI_FWBLOCKWRITE_ENABLE )
			rc = shtps_rmi_write_fw_data(ts, ts->map.fn34.dataBase + 2, 
											&fwdata[(block * blockSize)]);
			SPI_ERR_CHECK(rc, err_exit);
		#else
			{
				int i;
...
static int shtps_statef_active_formchange(struct shtps_rmi_spi *ts, int param)
{
	...
	u8	fingerMax = SHTPS_FINGER_MAX; /* F11_QUERY_NUMOFFINGERS(ts->map.fn11.query.data) + 1; */
	...
	for(i = 0;i < fingerMax;i++){
		if(ts->report_info.fingers[i].state != 0x00 && y >= CONFIG_SHTPS_SY3000_LCD_SIZE_Y){
			...
			shtps_report_touch_cancel(ts, i);
		}
	}
	input_sync(ts->input);
...
#if defined( SHTPS_VKEY_INVALID_AREA_DEBUG_ENABLE )
    &dev_attr_invarea.attr,
#endif /* #if defined( SHTPS_VKEY_INVALID_AREA_DEBUG_ENABLE ) */

#if defined( SHTPS_HOST_POS_FILTER_ENABLE ) && defined( SHTPS_DEBUG_VARIABLE_DEFINES )
	&dev_attr_posfilter.attr,
	&dev_attr_verticalposfilter.attr,
	&dev_attr_posret.attr,
#endif /* #if defined( SHTPS_HOST_POS_FILTER_ENABLE ) && defined( SHTPS_DEBUG_VARIABLE_DEFINES ) */
...
static int __devinit shtps_rmi_probe(struct spi_device *spi)
{
...
#if defined( SHTPS_HOST_POS_FILTER_ENABLE )
	shtps_posfilter_init(ts);
	memset(ts->fslurinfo,    0, sizeof(ts->fslurinfo));
#endif /* #if defined( SHTPS_HOST_POS_FILTER_ENABLE ) */
...
#if defined( SHTPS_WAKELOCK_IN_TOUCH_ENABLE )
	ts->wake_lock_state = 0;
	wake_lock_init(&ts->wake_lock_idle, WAKE_LOCK_IDLE, "shtps_touch_wake_lock");
#endif /* #if defined( SHTPS_WAKELOCK_IN_TOUCH_ENABLE ) */
	...
	shtps_invalid_area[0].sy = CONFIG_SHTPS_SY3000_LCD_SIZE_Y;
	shtps_invalid_area[0].ex = CONFIG_SHTPS_SY3000_PANEL_SIZE_X;
	shtps_invalid_area[0].ey = CONFIG_SHTPS_SY3000_LCD_SIZE_Y + (shtps_invarea_debug_bottom - 1);

	shtps_invalid_area[1].sx = 0;
	shtps_invalid_area[1].sy = CONFIG_SHTPS_SY3000_LCD_SIZE_Y;
	shtps_invalid_area[1].ex = shtps_invarea_debug_left - 1;
	shtps_invalid_area[1].ey = CONFIG_SHTPS_SY3000_PANEL_SIZE_Y;

	shtps_invalid_area[2].sx = CONFIG_SHTPS_SY3000_PANEL_SIZE_X - (shtps_invarea_debug_right - 1);
	shtps_invalid_area[2].sy = CONFIG_SHTPS_SY3000_LCD_SIZE_Y;
	shtps_invalid_area[2].ex = CONFIG_SHTPS_SY3000_PANEL_SIZE_X;
	shtps_invalid_area[2].ey = CONFIG_SHTPS_SY3000_PANEL_SIZE_Y;

	shtps_invalid_area[3].sx = -1;
	shtps_invalid_area[3].sy = -1;
	shtps_invalid_area[3].ex = -1;
	shtps_invalid_area[3].ey = -1;
	#endif /* #if defined( SHTPS_VKEY_INVALID_AREA_DEBUG_ENABLE ) */
...
#if defined( SHTPS_WAKELOCK_IN_TOUCH_ENABLE )
	wake_lock_destroy(&ts->wake_lock_idle);
#endif /* #if defined( SHTPS_WAKELOCK_IN_TOUCH_ENABLE ) */
...
#if defined( SHTPS_CHARGER_ARMOR_ENABLE )
	struct shtps_rmi_spi *ts = gShtps_rmi_spi;
	shtps_set_charger_armor(ts, nMode);
#endif /* #if defined( SHTPS_CHARGER_ARMOR_ENABLE ) */
}

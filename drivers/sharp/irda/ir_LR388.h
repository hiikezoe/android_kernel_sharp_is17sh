/* drivers/sharp/irda/ir_LR388.h (IrDA SIR/FIR driver module)
 *
...
extern void __iomem *lr388_hcs1;
extern void __iomem *lr388_hcs2;

#define	IR_GLT_REG_BASE		lr388_hcs1
#define	IR_GLT_IRDA_BASE	lr388_hcs2
...
#else
#define	IR_GLT_REG_INTR0	(IR_GLT_REG_BASE + 0x0010)
#define	IR_GLT_REG_INTM0	(IR_GLT_REG_BASE + 0x0030)
#define	IR_GLT_REG_IRDADIV	(IR_GLT_REG_BASE + 0x00D0)
#define	IR_GLT_REG_IRDASYS	(IR_GLT_REG_BASE + 0x9600)
#endif
...
#else
#define	IR_REG_CR_OFFSET	0xC000
#endif
...
#else
#define	IR_REG_SR_OFFSET	0xC080
#endif

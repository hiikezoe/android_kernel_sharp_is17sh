...
/* [WLAN][SHARP] 2012.05.31 dhd_download_fw_on_driverload is FALSE */
#ifdef SH_ENABLE_INSMOD_NO_FW_LOAD
int  dhd_os_wake_lock(dhd_pub_t *pub);
int  dhd_os_wake_unlock(dhd_pub_t *pub);
#endif /* SH_ENABLE_INSMOD_NO_FW_LOAD */
/* [WLAN][SHARP] 2012.05.31 dhd_download_fw_on_driverload is FALSE */
...
#endif
/* [WLAN][SHARP] 2011.06.01 Returning from suspend ,"Wake Lock" to maintain  mod Start */
	struct wake_lock wl_wifi;   /* Wifi wakelock */
#if 0 //Not Used "rx wakelock"
	struct wake_lock wl_rxwake; /* Wifi rx wakelock */
#endif
	spinlock_t wakelock_spinlock;
	int wakelock_counter;
	int wakelock_timeout_enable;
/* [WLAN][SHARP] 2011.06.01 Returning from suspend ,"Wake Lock" to maintain  mod  End  */
...
/* [WLAN][SHARP] 2011.03.10 Initialization error handling Start */
#ifdef SH_CONFIG_WLAN_STATIC
    dhd_attach_states_t dhd_state;
#endif
/* [WLAN][SHARP] 2011.03.10 Initialization error handling  End  */
...
/* [WLAN][SHARP] 2011.03.10 modification for static link Start */
#ifndef SH_CONFIG_WLAN_STATIC
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 27))
struct semaphore dhd_registration_sem;
#define DHD_REGISTRATION_TIMEOUT  12000  /* msec : allowed time to finished dhd registration */
#endif /* (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 27)) */
#endif
/* [WLAN][SHARP] 2011.03.10 modification for static link  End  */
...
#if 0 /* [WLAN][SHARP] 2011.01.20 mod Start */
...
{
/* [WLAN][SHARP] 2011.04.11 Remedy for IEEE-PS problem Start */
#if 0
	int power_mode = PM_MAX;
#else
	int power_mode = PM_FAST;
#endif
/* [WLAN][SHARP] 2011.04.11 Remedy for IEEE-PS problem End */
...
/* [WLAN][SHARP] 2011.11.14 wifi eco mode Start */
#if 0
				...
				bcm_mkiovar("bcn_li_dtim", (char *)&bcn_li_dtim,
					4, iovbuf, sizeof(iovbuf));
#endif
/* [WLAN][SHARP] 2011.11.14 wifi eco mode End */
...
/* [WLAN][SHARP] 2011.01.20 Add for Gingerbread Start */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 35)
	struct netdev_hw_addr *ha;
#else
	struct dev_mc_list *mclist;
#endif
/* [WLAN][SHARP] 2011.01.20 Add for Gingerbread End */
	uint32 allmulti, cnt;
...
/* [WLAN][SHARP] 2011.04.07 Fixed incorrect variable reference Start */
#if 0
	ASSERT(&dhd->thr_sysioc_ctl.thr_pid >= 0);
#else
	ASSERT(dhd->thr_sysioc_ctl.thr_pid >= 0);
#endif
/* [WLAN][SHARP] 2011.04.07 Fixed incorrect variable reference  End */
...
#ifdef SH_CONFIG_WLAN_STATIC
	if (reject_ioctl){
	    DHD_ERROR(("%s: ioctl is rejected because of WLAN shutdown\n", __FUNCTION__));
	    return -1;
	}
#endif
/* [WLAN][SHARP] 2011.05.12 mod Static Link Review  End  */
...
/* [WLAN][SHARP] 2012.05.31 dhd_download_fw_on_driverload is FALSE */
#ifndef SH_ENABLE_INSMOD_NO_FW_LOAD
		return -1;
#else
		ret = -1;
		goto exit;
...
/* [WLAN][SHARP] 2011.03.15 modification for problems when system suspend Start */
#if 0
	dhdp->pktfilter_count = 1;
	/* Setup filter to allow only unicast */
	dhdp->pktfilter[0] = "100 0 0 0 0x01 0x00";
#else
    /* We do not permit packet filtering when system suspend. */
    /* Because unexpected problems occur in some applications. */
	dhdp->pktfilter_count = 0;
#endif
/* [WLAN][SHARP] 2011.03.15 modification for problems when system suspend End */
...
#endif /* (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 27)) */
#endif
/* [WLAN][SHARP] 2011.03.10 modification for static link  Emd  */
...
#ifdef SH_CONFIG_WLAN_STATIC
void
dhd_stop_thr_sysioc(dhd_pub_t *dhdp)
{
    dhd_info_t *dhd;
...
/* [WLAN][SHARP] 2011.03.10 Initialization error handling Start */
	...
	if (dhd->dhd_state & DHD_ATTACH_STATE_THREADS_CREATED) {
			if (dhd->thr_sysioc_ctl.thr_pid >= 0) {
/* [WLAN][SHARP] 2011.04.26 "4.218.248.27 " A Update Miss mod Start */
				PROC_STOP(&dhd->thr_sysioc_ctl);
/* [WLAN][SHARP] 2011.04.26 "4.218.248.27 " A Update Miss mod End */
			}
	}
...
#else /* [WLAN][SHARP] 2011.03.10 Initialization error handling  */
#if defined(CONFIG_HAS_EARLYSUSPEND)
		if (dhd->early_suspend.suspend)
			unregister_early_suspend(&dhd->early_suspend);
#endif	/* defined(CONFIG_HAS_EARLYSUSPEND) */
...
dhd_module_init(void)
{
  /* [WLAN][SHARP] 2011.05.12 mod Static Link Review Start */
#if 1
  int error = 0; /* just intialize to avoid build error */
#else
  int error;
#endif
/* [WLAN][SHARP] 2011.05.12 mod Static Link Review  End  */
...
#endif
#endif
/* [WLAN][SHARP] 2011.03.10 modification for static link  End t */
	return error;
...
/* [WLAN][SHARP] 2012.05.31 dhd_download_fw_on_driverload is FALSE Start */
#ifdef SH_ENABLE_INSMOD_NO_FW_LOAD
	if(fw_path == NULL || fw_path[0] == '\0'){
		DHD_ERROR(("%s: Suppress getting wireless stats until firmware path set.\n", __func__));
		DHD_ERROR(("%s: Because driver is not starting up.\n", __func__));
		return NULL;
	}
#endif
/* [WLAN][SHARP] 2012.05.31 dhd_download_fw_on_driverload is FALSE End */

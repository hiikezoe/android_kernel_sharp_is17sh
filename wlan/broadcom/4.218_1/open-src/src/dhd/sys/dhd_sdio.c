...
extern void  dhd_os_wake_lock(dhd_pub_t *pub);
extern void  dhd_os_wake_unlock(dhd_pub_t *pub);
...
/* [WLAN][SHARP] 2011.03.10 add error log Start */
		DHD_ERROR(("%s:Tx Delta Error :%d\n",__FUNCTION__,	((uint8)(bus->tx_max - bus->tx_seq) ) ) );
/* [WLAN][SHARP] 2011.03.10 add error log  End */
		resched = TRUE;
	}
...
extern void dhd_stop_thr_sysioc(dhd_pub_t *dhdp);
#endif
/* [WLAN][SHARP] 2011.05.12 mod Static Link Review  End  */

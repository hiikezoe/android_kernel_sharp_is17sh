...
// SH_AUDIO_DRIVER [+9.0dB for LPA] -->
#if 1
#define MSM_LPA_MAX_VOLUME 0x6000
#define MSM_LPA_MAX_VOLUME_MULT 3
#endif
// SH_AUDIO_DRIVER [+9.0dB for LPA] <--
...
#else
	if ((volume < 0) || (volume/factor > (100 * MSM_LPA_MAX_VOLUME_MULT)))
#endif
// SH_AUDIO_DRIVER [+9.0dB for LPA] <--
		return -EINVAL;
...
#else
	if (volume > MSM_LPA_MAX_VOLUME)
		volume = MSM_LPA_MAX_VOLUME;
#endif
// SH_AUDIO_DRIVER [+9.0dB for LPA] <--

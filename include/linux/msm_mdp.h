...
#define MSMFB_OVERLAY_PLAY_W      _IOW(MSMFB_IOCTL_MAGIC, 170, \
						struct msmfb_overlay_data_w)

#define MSMFB_PAN_ENABLE _IOW(MSMFB_IOCTL_MAGIC, 171, unsigned int)
...
#define MDP_CCS_YUV_BT601	0
#define MDP_CCS_YUV_BT709 	1
...
struct msmfb_overlay_data_w {
	uint32_t id1;
	uint32_t id2;
	struct msmfb_data data1;
	struct msmfb_data data2;
	uint32_t version_key;
	struct msmfb_data plane1_data1;
	struct msmfb_data plane2_data1;
	struct msmfb_data plane1_data2;
	struct msmfb_data plane2_data2;
};

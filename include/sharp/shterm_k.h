...
#ifdef CONFIG_SHTERM_DEC
    SHBATTLOG_EVENT_UIM_OK,
    SHBATTLOG_EVENT_UIM_ERR_R_UIM_DET,
    SHBATTLOG_EVENT_UIM_ERR_MS_OP_MODE,
    SHBATTLOG_EVENT_UIM_ERR_UIMID_DUP,
    SHBATTLOG_EVENT_UIM_ERR_PUIMID_DUP,
    SHBATTLOG_EVENT_UIM_ERR_AIR_LOCK_BLK,
    SHBATTLOG_EVENT_UIM_ERR_AIR_LOCK_ASH,
    SHBATTLOG_EVENT_UIM_ERR_AIR_LOCK_WHT,
    SHBATTLOG_EVENT_UIM_ERR_NW_LOCK,
    SHBATTLOG_EVENT_UIM_ERR_SP_LOCK,
    SHBATTLOG_EVENT_UIM_ERR_UG_LOCK,
    SHBATTLOG_EVENT_UIM_ERR_UIM_INIT,
    SHBATTLOG_EVENT_UIM_ERR_CAT_INIT,
    SHBATTLOG_EVENT_UIM_ERR_CARD_ERROR,
    SHBATTLOG_EVENT_UIM_ERR_AIR_DATA,
    SHBATTLOG_EVENT_UIM_ERR_APP_DATA,
    SHBATTLOG_EVENT_UIM_ERR_CARD_NONE,
    SHBATTLOG_EVENT_UIM_ERR_GSM_BFPIN,
    SHBATTLOG_EVENT_UIM_ERR_GSM_AFPIN,
    SHBATTLOG_EVENT_UIM_ERR_OSEA_ASH,
#endif /* CONFIG_SHTERM_DEC */

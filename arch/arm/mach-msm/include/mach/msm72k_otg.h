...
enum usb_sh_chg_det_stage {
	CHG_DET_STAGE_NOT_START = 0,
	CHG_DET_STAGE_WAIT_FOR_DCD,
	CHG_DET_STAGE_DCD_DONE,	/* not used */
	CHG_DET_STAGE_COMPLETE,
};
enum usb_sh_chg_det_state {
	CHG_DET_VBUS_LOW = 0,
	CHG_DET_DCD_NOT_DETECT,
	CHG_DET_DCD_WAIT_FOR_DP_LOW,
	CHG_DET_DCD_DETECT,
	CHG_DET_SDP,
	CHG_DET_DCP,
	CHG_DET_CPD,
...
struct msm_otg {
	...
	struct delayed_work fsafe_work;
	enum usb_sh_chg_det_stage chg_stage;
	enum usb_sh_chg_det_state chg_det_type;
#endif /* CONFIG_USB_MSM_OTG_72K_SH_CUST */
};

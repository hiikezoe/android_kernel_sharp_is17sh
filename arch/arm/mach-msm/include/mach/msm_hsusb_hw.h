...
#if defined(CONFIG_USB_ANDROID_SH_CUST) || defined(CONFIG_USB_MSM_OTG_72K_SH_CUST)
#define ULPI_FUNCTION_CONTROL_REG     0x04
#endif /* defined(CONFIG_USB_ANDROID_SH_CUST) || defined(CONFIG_USB_MSM_OTG_72K_SH_CUST) */

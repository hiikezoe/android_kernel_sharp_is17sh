...
static bool SetAudioWakeLockFlag = 0;
...
#ifdef CONFIG_SH_AUDIO_DRIVER
bool audpreproc_get_wake_lock_status(void)
{
	return SetAudioWakeLockFlag;
}
EXPORT_SYMBOL(audpreproc_get_wake_lock_status);
#endif /* CONFIG_SH_AUDIO_DRIVER */

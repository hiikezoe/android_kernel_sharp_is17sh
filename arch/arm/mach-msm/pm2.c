...
#if defined(CONFIG_SHSYS_CUST) && ( defined(CONFIG_MMC_SDIO_CUST_SH) ||  defined(CONFIG_IDLECTRL_EMMC_CUST_SH) )
...
static int __init msm_pm_init(void)
{
	...
	if (*pSleepSmemSleepDisabled) {
		msm_pm_modes[MSM_PM_SLEEP_MODE_POWER_COLLAPSE].suspend_supported = 0;
		msm_pm_modes[MSM_PM_SLEEP_MODE_POWER_COLLAPSE].idle_supported = 0;
		msm_pm_modes[MSM_PM_SLEEP_MODE_POWER_COLLAPSE_NO_XO_SHUTDOWN].suspend_supported = 0;
		msm_pm_modes[MSM_PM_SLEEP_MODE_POWER_COLLAPSE_NO_XO_SHUTDOWN].idle_supported = 0;
		msm_pm_modes[MSM_PM_SLEEP_MODE_POWER_COLLAPSE_STANDALONE].suspend_supported = 0;
		msm_pm_modes[MSM_PM_SLEEP_MODE_POWER_COLLAPSE_STANDALONE].idle_supported = 0;
		msm_pm_modes[MSM_PM_SLEEP_MODE_WAIT_FOR_INTERRUPT].suspend_supported = 0;
		msm_pm_modes[MSM_PM_SLEEP_MODE_WAIT_FOR_INTERRUPT].idle_supported = 0;
	}

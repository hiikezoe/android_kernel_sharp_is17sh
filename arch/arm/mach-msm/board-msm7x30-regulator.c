...
static struct proccomm_regulator_info msm7x30_pcom_vreg_info[] = {
	...
	PCOM_VREG_LDO(ldo02, 46, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo03, 19, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo04,  9, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo05, 18, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo06, 16, NULL,  3075000,  3400000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo07, 44, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo08, 32, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo09,  8, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo10,  7, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo11, 21, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo12, 34, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo13, 15, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo14, 24, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo15, 23, NULL,  1500000,  3100000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo16, 35, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo17, 36, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo18, 37, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo19, 45, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo20, 38, NULL,  1500000,  3050000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo21, 39, NULL,   750000,  1525000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo22, 40, NULL,   750000,  1525000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo23, 22, NULL,   750000,  1525000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo24, 41, NULL,   750000,  1525000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo25, 42, NULL,   750000,  1525000, 0, -1, 0, 0, 0, 0),

	/* Low-voltage switches */
	PCOM_VREG_LVS(lvsw0, 47, NULL,                     0, -1, 0, 0),
	PCOM_VREG_LVS(lvsw1, 48, NULL,                     0, -1, 0, 0),

	PCOM_VREG_NCP(ncp,   31, NULL, -1800000, -3050000, 0,     0, 0, 0, 0),
};

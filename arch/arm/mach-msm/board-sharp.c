...
#ifdef CONFIG_SENSORS_SHGEIGER
#include <sharp/shgeiger.h>
#include <sharp/shgeiger_sub.h>
#endif	/* CONFIG_SENSORS_SHGEIGER */
...
#ifdef CONFIG_USB_VBUS_POWER
#include <sharp/shusb_vbus_power.h>
#endif /* CONFIG_USB_VBUS_POWER */
...
#define	MSM_FB_SIZE		0xA2A000
#elif	defined(CONFIG_MACH_LYNX_DC60) || defined(CONFIG_MACH_NNK)
#define	MSM_FB_SIZE		0x4B1000
#else	/*CONFIG_MACH_RYK*/
#ifdef	CONFIG_FB_MSM_TRIPLE_BUFFER
#define	SHLCDC_FB_NUM	3
#else	/*CONFIG_FB_MSM_TRIPLE_BUFFER*/
#define	SHLCDC_FB_NUM	2
#endif	/*CONFIG_FB_MSM_TRIPLE_BUFFER*/
#define	SHLCDC_FB_WIDTH		(((CONFIG_SHLCDC_PANEL_SIZE_WIDTH + 31)/32)*32)
#define	SHLCDC_FB_HEIGHT	(CONFIG_SHLCDC_PANEL_SIZE_HEIGHT)
#define	SHLCDC_FB_SIZE_FIX	(SHLCDC_FB_WIDTH * SHLCDC_FB_HEIGHT * 4 * SHLCDC_FB_NUM)
#define	SHLCDC_FB_SIZE_LCD	(((SHLCDC_FB_SIZE_FIX + 4095)/4096)*4096)
#define	MSM_FB_SIZE			(SHLCDC_FB_SIZE_LCD + SHHDMI_FB_SIZE)
#endif	/*CONFIG_MACH_RYK*/
...
#if defined(CONFIG_MACH_LYNX_DC60)
    #define MSM_PMEM_ADSP_SIZE      0x3ABC000
#elif defined(CONFIG_MACH_NNK) || defined(CONFIG_MACH_DECKARD_AF33) || defined(CONFIG_MACH_DECKARD_AS46)
    #define MSM_PMEM_ADSP_SIZE      0x32BC000
#else
    #define MSM_PMEM_ADSP_SIZE      0x1E00000
#endif /* defined(CONFIG_MACH_LYNX_DC60) || defined(CONFIG_MACH_NNK) || defined(CONFIG_MACH_DECKARD_AF33) || defined(CONFIG_MACH_DECKARD_AS46) */
#define MSM_FLUID_PMEM_ADSP_SIZE	0x2800000
#define PMEM_KERNEL_EBI0_SIZE   0xEB4000
#define MSM_PMEM_AUDIO_SIZE     0x1000000
...
static struct pm8xxx_keypad_platform_data surf_keypad_data = {
	...
	.rows_gpio_start	= PM8058_GPIO_PM_TO_SYS(SH_ROWS_GPIO_START),
	.cols_gpio_start	= PM8058_GPIO_PM_TO_SYS(SH_COLS_GPIO_START),
...
#endif /* defined(CONFIG_T8EV4) */
#if defined(CONFIG_S5K4EC)
	{
		I2C_BOARD_INFO("s5k4ec", 0x78 >> 1 ),
	},
...
#if defined(CONFIG_SENSORS_AMI602) || defined(CONFIG_MPU_SENSORS_MPU3050) || defined(CONFIG_I2C_CUST_SH) || defined(CONFIG_T8EV4) || defined(CONFIG_S5K4EC)
#else
GPIO_CFG(1, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* VCM */
#endif	/* CONFIG_SENSORS_AMI602 || CONFIG_MPU_SENSORS_MPU3050 || CONFIG_I2C_CUST_SH || CONFIG_T8EV4 || CONFIG_S5K4EC */
};

static uint32_t camera_off_gpio_table[] = {
#if defined( CONFIG_I2C_CUST_SH ) || defined(CONFIG_T8EV4) || defined(CONFIG_S5K4EC)
#else
...
#endif	/* CONFIG_I2C_CUST_SH || CONFIG_T8EV4 || CONFIG_S5K4EC */

#if defined(CONFIG_MACH_NNK)
    GPIO_CFG(15, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA),  /* MCLK */
#else
    GPIO_CFG(15, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_10MA), /* MCLK */
#endif /* defined(CONFIG_S5K4EC) */
};
...
#if !defined(CONFIG_T8EV4) && !defined(CONFIG_S5K4EC)
	/* FLUID: CAM_VGA_RST_N */
...
#endif /* !defined(CONFIG_T8EV4) && !defined(CONFIG_S5K4EC) */
};
...
#if defined(CONFIG_SH_CAMLED) || defined(CONFIG_MSM_CAMERA_FLASH)
	.flash_type = MSM_CAMERA_FLASH_LED,
#else
	.flash_type = MSM_CAMERA_FLASH_NONE,
#endif /* defined(CONFIG_SH_CAMLED) || defined(CONFIG_MSM_CAMERA_FLASH) */
	.flash_src  = &msm_flash_src_pwm
};
...
static struct platform_device msm_camera_sensor_s5k4ec = {
...
#if defined(CONFIG_SH_OV7692)
static struct msm_camera_sensor_flash_data flash_sh_ov7692 = {
	.flash_type = MSM_CAMERA_FLASH_NONE,
	.flash_src  = &msm_flash_src_pwm
};

static struct msm_camera_sensor_info msm_camera_sensor_sh_ov7692_data = {
	.sensor_name    = "sh_ov7692",
	.sensor_reset   = 0,
	.sensor_pwd     = 0,
	.vcm_pwd        = 0,
	.vcm_enable     = 0,
	...
	.resource       = msm_camera_resources,
	.num_resources  = ARRAY_SIZE(msm_camera_resources),
	.flash_data     = &flash_sh_ov7692,
	.csi_if         = 0
};

static struct platform_device msm_camera_sensor_sh_ov7692 = {
	.name      = "msm_camera_sh_ov7692",
	.dev       = {
		.platform_data = &msm_camera_sensor_sh_ov7692_data,
	},
};
#endif /* defined(CONFIG_SH_OV7692) */
...
static struct i2c_board_info msm_i2c_board_info[] = {
	...
	{
		I2C_BOARD_INFO("sh_spamp_i2c", 0xEC >> 1),
	},
#endif /* #if defined( CONFIG_SHSPAMP_AK7833 ) */
#if defined( CONFIG_SHHPAMP_WM8918 )
	{
		I2C_BOARD_INFO("sh_hpamp_i2c", 0x34 >> 1),
	},
#endif /* #if defined( CONFIG_SHHPAMP_WM8918 ) */
#if defined( CONFIG_SHVIBRATOR_LINEAR )
	{
		I2C_BOARD_INFO("sh_vib_i2c", 0x92 >> 1),
	},
#endif/* #if defined( CONFIG_SHVIBRATOR_LINEAR ) */
#endif /* #if defined( CONFIG_SH_AUDIO_DRIVER ) */
#ifdef CONFIG_SENSORS_AMI603
	{
...
#ifdef CONFIG_SENSORS_SHGEIGER
	{
		I2C_BOARD_INFO(SH_GEIGER_I2C_DEVNAME, SH_GEIGER_ASIC_I2C_SLAVE),
		.type           = SH_GEIGER_I2C_DEVNAME,
	},
	{
		I2C_BOARD_INFO(SH_GEIGERSUB_I2C_DEVNAME, SH_GEIGER_EPPROM_I2C_SLAVE),
		.type           = SH_GEIGERSUB_I2C_DEVNAME,
	},
#endif	/* CONFIG_SENSORS_SHGEIGER */
};
...
/* virtual keys */
static ssize_t shtps_vkeys_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
{
	return sprintf(buf,
	    __stringify(EV_KEY) ":" __stringify(KEY_MENU) CONFIG_SHTPS_SY3000_VIRTUAL_KEY_MENU
	":" __stringify(EV_KEY) ":" __stringify(KEY_HOME) CONFIG_SHTPS_SY3000_VIRTUAL_KEY_HOME
	":" __stringify(EV_KEY) ":" __stringify(KEY_BACK) CONFIG_SHTPS_SY3000_VIRTUAL_KEY_BACK
	"\n");
}

static struct kobj_attribute shtps_vkeys_attr = {
	.attr = {
		.mode = S_IRUGO,
	},
	.show = &shtps_vkeys_show,
};

static struct attribute *shtps_properties_attrs[] = {
	&shtps_vkeys_attr.attr,
	NULL
};

static struct attribute_group shtps_properties_attr_group = {
	.attrs = shtps_properties_attrs,
};

static struct kobject *shtps_vkeys_properties_kobj;
#endif /* #if defined( CONFIG_SHTPS_SY3000_VIRTUAL_KEY ) */

#if defined( CONFIG_SHTPS_TMA3XX_VIRTUAL_KEY )
/* virtual keys */
static ssize_t shtps_tma_vkeys_show(struct kobject *kobj,
			struct kobj_attribute *attr, char *buf)
{
	return sprintf(buf,
...
static struct kobj_attribute shtps_tma_vkeys_attr = {
	...
	.show = &shtps_tma_vkeys_show,
};

static struct attribute *shtps_tma_properties_attrs[] = {
	&shtps_tma_vkeys_attr.attr,
	NULL
};

static struct attribute_group shtps_tma_properties_attr_group = {
	.attrs = shtps_tma_properties_attrs,
};

static struct kobject *shtps_tma_vkeys_properties_kobj;
#endif	/* #if defined( CONFIG_SHTPS_TMA3XX_VIRTUAL_KEY ) */
...
#if defined( CONFIG_SHTPS_SY3000_VIRTUAL_KEY )
	/* virtual keys */
	shtps_vkeys_attr.attr.name = "virtualkeys.shtps_rmi";
	shtps_vkeys_properties_kobj = kobject_create_and_add("board_properties", NULL);
	if (!shtps_vkeys_properties_kobj) {
		pr_err("%s: failed to create a kobject"
				"for board_properites\n", __func__);
		rc = -ENOMEM;
		goto vreg_get_fail;
	}
	rc = sysfs_create_group(shtps_vkeys_properties_kobj,
			&shtps_properties_attr_group);
	if (rc) {
		pr_err("%s: failed to create a sysfs entry %s\n",
				__func__, shtps_vkeys_attr.attr.name);
		kobject_put(shtps_vkeys_properties_kobj);
		goto vreg_get_fail;
	}
...
#else /* #if defined( CONFIG_SHTPS_SY3X00_DEV ) */

static int msm_shtps_gpio_setup(void)
{
	int rc;
...
#if defined( CONFIG_SHTPS_TMA3XX_VIRTUAL_KEY )
	/* virtual keys */
	shtps_tma_vkeys_attr.attr.name = "virtualkeys.SH_touchpanel";
	shtps_tma_vkeys_properties_kobj = kobject_create_and_add("board_properties", NULL);
	if (!shtps_tma_vkeys_properties_kobj) {
		pr_err("%s: failed to create a kobject"
				"for board_properites\n", __func__);
		rc = -ENOMEM;
		goto vreg_get_fail;
	}
	rc = sysfs_create_group(shtps_tma_vkeys_properties_kobj,
			&shtps_tma_properties_attr_group);
	if (rc) {
		pr_err("%s: failed to create a sysfs entry %s\n",
				__func__, shtps_tma_vkeys_attr.attr.name);
		kobject_put(shtps_tma_vkeys_properties_kobj);
		goto vreg_get_fail;
	}
...
static void msm_shtps_gpio_teardown(void)
{
	msm_gpios_disable_free(shtps_spi_gpio_config_data,
		ARRAY_SIZE(shtps_spi_gpio_config_data));
}

static struct msm_sh_spitps_platform_data shtps_pdata = {
	.gpio_irq       = SH_TOUCH_IRQ,
	.gpio_hssp_clk  = SH_TOUCH_HSSP_CLK,
	.gpio_hssp_data = SH_TOUCH_HSSP_DATA,
	.gpio_reset     = SH_TOUCH_RESET,
	.gpio_vcpin     = SH_TOUCH_VCPIN,
	.gpio_setup     = msm_shtps_gpio_setup,
	.gpio_teardown = msm_shtps_gpio_teardown,
};
...
{
#ifdef CONFIG_USB_EHCI_MSM_72K_SH_CUST
	/* PMIC gpio start 0(=GPIO 1) */
	#define D_MSM_HSUSB_VBUS_5V_EN	(25 - 1)
	#define D_MSM_HSUSB_VBUS_OVP	(26 - 1)
#endif /* CONFIG_USB_EHCI_MSM_72K_SH_CUST */

        int rc;
        static int vbus_is_on;
	struct pm8xxx_gpio_init_info usb_vbus = {
#ifdef CONFIG_USB_EHCI_MSM_72K_SH_CUST
		PM8058_GPIO_PM_TO_SYS(D_MSM_HSUSB_VBUS_OVP),
#else /* CONFIG_USB_EHCI_MSM_72K_SH_CUST */
        ...
        if (on) {
#ifdef CONFIG_USB_EHCI_MSM_72K_SH_CUST
		static int vbus_initilize = 0;

#ifdef CONFIG_USB_VBUS_POWER
		set_pm8058_5v_power_en(PM8058_5V_POWER_EN_USBHOST, 1);
#endif /* CONFIG_USB_VBUS_POWER */
		if (vbus_initilize) {
#ifndef CONFIG_USB_VBUS_POWER
			gpio_set_value_cansleep(
				PM8058_GPIO_PM_TO_SYS(D_MSM_HSUSB_VBUS_5V_EN), 1);
#endif /* CONFIG_USB_VBUS_POWER */
			gpio_set_value_cansleep(
				PM8058_GPIO_PM_TO_SYS(D_MSM_HSUSB_VBUS_OVP), 1);
		}
		else {
#ifndef CONFIG_USB_VBUS_POWER
			...
			PM8058_GPIO_PM_TO_SYS(D_MSM_HSUSB_VBUS_OVP),
				&usb_vbus.config);
			if (rc) {
				pr_err("%s OVP ERR:PMIC GPIO write failed\n", __func__);
				gpio_set_value_cansleep(
...
#ifdef CONFIG_USB_EHCI_MSM_72K_SH_CUST
		gpio_set_value_cansleep(
			PM8058_GPIO_PM_TO_SYS(D_MSM_HSUSB_VBUS_OVP), 0);
#ifdef CONFIG_USB_VBUS_POWER
		set_pm8058_5v_power_en(PM8058_5V_POWER_EN_USBHOST, 0);
#else /* CONFIG_USB_VBUS_POWER */
		gpio_set_value_cansleep(
			PM8058_GPIO_PM_TO_SYS(D_MSM_HSUSB_VBUS_5V_EN), 0);
#endif /* CONFIG_USB_VBUS_POWER */
#else /* CONFIG_USB_EHCI_MSM_72K_SH_CUST */
...
#endif /* defined(CONFIG_T8EV4) */
#if defined(CONFIG_S5K4EC)
	&msm_camera_sensor_s5k4ec,
#endif /* defined(CONFIG_S5K4EC) */
#if defined(CONFIG_SH_OV7692)
	&msm_camera_sensor_sh_ov7692,
#endif /* defined(CONFIG_SH_OV7692) */
#ifdef CONFIG_MSM_GEMINI
	&msm_gemini_device,
#endif
...
#elif CONFIG_I2C_CUST_SH_QUPGPIO == 1
...
#else /* CONFIG_I2C_CUST_SH_QUPGPIO == 2 */
	{ GPIO_CFG(0, 2, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "qup_scl" },
	{ GPIO_CFG(1, 2, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "qup_sda" },
...
static struct msm_gpio sdc1_cfg_data[] = {
#ifdef CONFIG_MMC_SDIO_CUST_SH
	#if defined(CONFIG_MACH_NNK)
		{GPIO_CFG(38, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA), "sdc1_clk"},
		{GPIO_CFG(39, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc1_cmd"},
		{GPIO_CFG(40, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc1_dat_3"},
		{GPIO_CFG(41, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc1_dat_2"},
		{GPIO_CFG(42, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc1_dat_1"},
		{GPIO_CFG(43, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc1_dat_0"},
	#elif defined(CONFIG_MACH_DECKARD_AS46) 
		{GPIO_CFG(38, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_10MA), "sdc1_clk"},
		{GPIO_CFG(39, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_10MA), "sdc1_cmd"},
		{GPIO_CFG(40, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_10MA), "sdc1_dat_3"},
		{GPIO_CFG(41, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_10MA), "sdc1_dat_2"},
		{GPIO_CFG(42, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_10MA), "sdc1_dat_1"},
		{GPIO_CFG(43, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_10MA), "sdc1_dat_0"},
	#else
	...
	{GPIO_CFG(42, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA), "sdc1_dat_1"},
	{GPIO_CFG(43, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA), "sdc1_dat_0"},
#endif /* CONFIG_MMC_SDIO_CUST_SH */
};

static struct msm_gpio sdc2_cfg_data[] = {
#ifdef CONFIG_MMC_CUST_SH
	#if defined(CONFIG_MACH_LYNX_DC60)
		{GPIO_CFG(64, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA), "sdc2_clk"},
		{GPIO_CFG(65, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA), "sdc2_cmd"},
		{GPIO_CFG(66, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA), "sdc2_dat_3"},
		{GPIO_CFG(67, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA), "sdc2_dat_2"},
		{GPIO_CFG(68, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA), "sdc2_dat_1"},
		{GPIO_CFG(69, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA), "sdc2_dat_0"},
	
		#ifdef CONFIG_MMC_MSM_SDC2_8_BIT_SUPPORT
			{GPIO_CFG(115, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA), "sdc2_dat_4"},
			{GPIO_CFG(114, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA), "sdc2_dat_5"},
			{GPIO_CFG(113, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA), "sdc2_dat_6"},
			{GPIO_CFG(112, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA), "sdc2_dat_7"},
		#endif	
	#elif defined(CONFIG_MACH_DECKARD_AS46) 
		...
		#endif	
	#else
		{GPIO_CFG(64, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_6MA), "sdc2_clk"},
		{GPIO_CFG(65, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc2_cmd"},
		{GPIO_CFG(66, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc2_dat_3"},
		{GPIO_CFG(67, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc2_dat_2"},
		{GPIO_CFG(68, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc2_dat_1"},
		{GPIO_CFG(69, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc2_dat_0"},
	
		#ifdef CONFIG_MMC_MSM_SDC2_8_BIT_SUPPORT
			{GPIO_CFG(115, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc2_dat_4"},
			{GPIO_CFG(114, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc2_dat_5"},
			{GPIO_CFG(113, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc2_dat_6"},
			{GPIO_CFG(112, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA), "sdc2_dat_7"},
		#endif
	#endif
...
static int msm_sdcc_get_wpswitch(struct device *dv)
{
	...
	if (!(machine_is_msm7x30_surf()) && !(machine_is_deckard_as46()) && !(machine_is_deckard_af33()) && !(machine_is_lynx_dc60()))
		return -1;
	pdev = container_of(dv, struct platform_device, dev);
...
static void __init pmic8058_leds_init(void)
{
	...
	else if (machine_is_deckard_as46())
		pm8058_7x30_data.leds_pdata = &pm8058_surf_leds_data;
	else if (machine_is_deckard_af33())
		pm8058_7x30_data.leds_pdata = &pm8058_surf_leds_data;
	else if (machine_is_lynx_dc60())
		pm8058_7x30_data.leds_pdata = &pm8058_surf_leds_data;
...
MACHINE_START(LYNX_DC60, "SHARP LYNX DC60")
	.boot_params = PLAT_PHYS_OFFSET + 0x100,
	.map_io = msm7x30_map_io,
	.reserve = msm7x30_reserve,
	.init_irq = msm7x30_init_irq,
...
MACHINE_START(DECKARD_AS46, "SHARP DECKARD AS46")
	.boot_params = PLAT_PHYS_OFFSET + 0x100,
	.map_io = msm7x30_map_io,
	.reserve = msm7x30_reserve,
	.init_irq = msm7x30_init_irq,
...
MACHINE_START(DECKARD_AF33, "SHARP DECKARD AF33")
	.boot_params = PLAT_PHYS_OFFSET + 0x100,
	.map_io = msm7x30_map_io,
	.reserve = msm7x30_reserve,
	.init_irq = msm7x30_init_irq,

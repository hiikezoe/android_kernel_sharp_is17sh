...
static struct wake_lock shsys_suspend_sleep;
#endif

static struct kernel_param_ops param_ops_debug_mask = {
	(void *)param_set_int,
	(void *)param_get_int
};
module_param_cb(debug_mask, &param_ops_debug_mask,
...
{
#ifdef CONFIG_SHSYS_CUST
	wake_unlock( &shsys_suspend_sleep );
#endif
...
#ifdef CONFIG_SHSYS_CUST
	wake_lock_init(&shsys_suspend_sleep, WAKE_LOCK_IDLE, "shsys_suspend_sleep");
#endif
